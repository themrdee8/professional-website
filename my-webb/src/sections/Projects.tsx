...
function Projects() {
  return (
    <div id="projects" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
      ...
      <p className="py-8 sm:text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, ea amet ratione dolorem non culpa eligendi, enim et nemo quidem rem tempore quod recusandae obcaecati, voluptatum ex adipisci cum illum!</p>
